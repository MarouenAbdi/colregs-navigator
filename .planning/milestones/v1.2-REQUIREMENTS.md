# Requirements Archive: v1.2 Tech Debt & Stabilization
...
- [x] **CMNT-01**: All comments referencing Phase/Plan/REQ-IDs are rewritten by hand, one comment at a time, to preserve their substantive WHY content while removing the rotting identifier — not via a mechanical regex strip, since these IDs are woven into explanatory sentences rather than standalone tags in this codebase — Done Phase 13, human sign-off approved 2026-07-20
- [x] **CMNT-02**: A broader re-grep (beyond the strict numeric Phase/Plan/REQ-ID pattern used to originally scope this milestone) is run to catch any additional stale references, since the original count is known to be an undercount — Done Phase 13 Plan 07/08 (broader sweep + final verification)

## v2 Requirements

Carried forward to a future milestone (see `.planning/research/FEATURES.md` for full rationale):
...
| CMNT-01 | Phase 13 | Done |
| CMNT-02 | Phase 13 | Done |

**Coverage:**
- v1.2 requirements: 22 total
- Mapped to phases: 22/22 ✓
- Unmapped: 0
- Validated: 22/22 ✓ (CMNT-01/CMNT-02 confirmed via Phase 13's human sign-off, 2026-07-20 — their checkboxes were stale in REQUIREMENTS.md at milestone-close time and corrected as part of archiving)

---
*Requirements defined: 2026-07-19*
*Last updated: 2026-07-20 — archived at milestone close. All 22/22 v1.2 requirements validated.*
