...
- **D-09:** No flash/highlight animation this phase — the scroll landing on a visibly different chart/verdict is the acknowledgment. Matches `.planning/research/FEATURES.md`'s MVP scope, which defers this explicitly to "Add After Validation." Out of scope for Phase 17, not silently dropped.
